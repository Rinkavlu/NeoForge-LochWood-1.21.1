...
@Mod(Lockwood.MOD_ID)
public class Lockwood
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "lockwood";
    ...
    public Lockwood(IEventBus modEventBus, ModContainer modContainer)
    {
    ...
    { if(event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS){
        event.accept(ModItems.ANCIENTTREAT);
    }
